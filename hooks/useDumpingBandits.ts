// Generated by @wagmi/cli@0.1.6 on 2/14/2023 at 5:08:06 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const dumpingBanditsABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct DumpingBandits.Round',
        type: 'tuple',
        components: [
          ...
          { name: 'prizes', internalType: 'uint256[]', type: 'uint256[]' },
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link dumpingBanditsABI}__ and `functionName` set to `"currentRound"`.
 */
export function useDumpingBanditsCurrentRound(
  config: Omit<
    UseContractReadConfig<typeof dumpingBanditsABI, 'currentRound'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof dumpingBanditsABI, 'currentRound'>)
}
